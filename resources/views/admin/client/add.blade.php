            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <h2>CLient Review  add form</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('dashboard')}}"><i class="fa fa-dashboard"></i></a></li>
                            <li class="breadcrumb-item">Client review</li>
                            <li class="breadcrumb-item active">add client review</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{route('client.store')}}" method="post" id="basic-form" method="post" enctype="multipart/form-data"  >@csrf
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="review" class="form-control" value="{{old('review')}}"></textarea>
