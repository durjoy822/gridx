            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{route('contact.store')}}" method="post" id="basic-form" enctype="multipart/form-data" >@csrf
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label>Email_one</label>
                                        <input type="text" name="email_1" value="{{old('email_1')}}"  class="form-control" >
                                        <div class="text-danger">@error('email_1'){{$message}}@enderror </div>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label>Email_two</label>
                                        <input type="email_2" name="email_2" value="{{old('email_2')}}" class="form-control" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" name="Num_1" value="{{old('Num_1')}}"  class="form-control" >
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="num_2" name="num_2" value="{{old('num_2')}}" class="form-control" >
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" name="location_1" value="{{old('location_1')}}"  class="form-control" >
